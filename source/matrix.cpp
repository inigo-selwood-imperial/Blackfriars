...
/*
This source file is split into 9 parts:

    (1) Stream print operators
        Allows a matrix, matrix size, or matrix index class to be printed to an
        std::ostream

    (2) Binary maths operators
        Some syntactic sugar for matrix maths (addition, multiplication, etc.)

    (3) Equivalence operators

    (4) Access operators
        Allows accesing references and const copies of the values contained by
        a matrix

    (5) Constructors

    (6) Data management helpers
        Functions for restructuring the matrix: resizing or clearing its
        contents

    (7) Matrix operations
        Some of the more complicated matrix functions, like calculating its
        determinant, adjugant, etc.

    (8) Characteristic access functions
        Functions for accessing information about the matrix, such as the number
        of columns/rows, or the direct values contained by the matrix

    (9) Row-major order conversion helpers
        Used for converting between indices and offsets
*/

// ****************************************************** Stream print operators
...
// ********************************************* Characteristic access functions
...
// ****************************************** Row-major order conversion helpers
